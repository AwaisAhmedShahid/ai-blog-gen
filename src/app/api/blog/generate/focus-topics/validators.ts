...
// -- POST
export const postGenerateFocusTopicsReqSchema = z.object({
  tags: z.array(z.string().min(1, "Title should be at least 5 character long")),
});

export type postGenerateFocusTopicsReqType = z.infer<typeof postGenerateFocusTopicsReqSchema>;
export type postGenerateFocusTopicsResType = GlobalApiResponse<z.infer<typeof postTextGenerationResSchema>>;
